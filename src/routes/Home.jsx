...
const Home = () => {
  return (
    <section className='text-main-color flex flex-col items-center justify-center w-full'>
      <div className='flex flex-col justify-center items-center text-7xl'>
        <h1 className='pb-4'>Nicolas Lima</h1>
        <h4 className='text-5xl pt-4'>Desenvolvedor Full Stack</h4>
      </div>
      <div className='flex justify-center items-center my-8'>
        <img
          src={eu}
          alt="Minha foto"
          className='w-80 rounded-xl border-none'
        />
      </div>
      <section className='flex items-center text-6xl text-text-color'>
