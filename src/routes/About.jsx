const About = () => {
  return (
    <section className="flex flex-col justify-center gap-y-16 mt-12 md:mt-28 mx-16 text-text-color min-h-screen text-lg text-justify 2xl:text-2xl w-4/5 md:w-2/3
